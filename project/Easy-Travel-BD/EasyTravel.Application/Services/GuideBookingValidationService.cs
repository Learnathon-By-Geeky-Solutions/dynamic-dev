...
{
    public class GuideBookingValidationService : IBookingValidationService<GuideBooking,Guid>
    {
        private readonly IApplicationUnitOfWork _applicationUnitOfWork;
        private readonly ILogger<GuideBookingValidationService> _logger;
        public GuideBookingValidationService(IApplicationUnitOfWork applicationUnitOfWork,ILogger<GuideBookingValidationService> logger)
        {
