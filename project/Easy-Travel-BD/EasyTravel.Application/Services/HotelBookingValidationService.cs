...
{
    public class HotelBookingValidationService : IBookingValidationService<HotelBooking,Guid>
    {
        private readonly IApplicationUnitOfWork _applicationUnitOfWork;
        private readonly ILogger<HotelBookingValidationService> _logger;
        public HotelBookingValidationService(IApplicationUnitOfWork applicationUnitOfWork,ILogger<HotelBookingValidationService> logger)
        {
        ...
        public async Task<bool> IsExist(Guid id)
        {
            try
            {
                ...
                return await _applicationUnitOfWork.HotelBookingRepository.GetByIdAsync(id) != null;
