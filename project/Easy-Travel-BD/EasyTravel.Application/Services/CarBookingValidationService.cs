...
{
    public class CarBookingValidationService : IBookingValidationService<CarBooking,Guid>
    {
        private readonly IApplicationUnitOfWork _applicationUnitOfWork;
        private readonly ILogger<CarBookingValidationService> _logger;
        public CarBookingValidationService(IApplicationUnitOfWork applicationUnitOfWork,ILogger<CarBookingValidationService> logger)
        {
        ...
        public async Task<bool> IsExist(Guid id)
        {
            try
            {
                ...
                return await _applicationUnitOfWork.CarBookingRepository.GetByIdAsync(id) != null;
