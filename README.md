...
|:-----------|:------------|:----:|
| **ASP.NET Core 9 (Latest)** | Built with the latest .NET 9 for faster performance, better security, and long-term support. | ![ASP.NET Core Logo](https://styles.redditmedia.com/t5_3c30n/styles/communityIcon_zk9okbrbph141.png) |
| **Entity Framework Core** | Used for ORM to interact with Microsoft SQL Server and reduce boilerplate code. | ![EF Core Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTT6qrV_veEayLR-iym799ZfXXk4D4D4R425w&s) |
| **Microsoft SQL Server** | Primary database for storing user, booking, and management data securely and efficiently. | ![SQL Server Logo](https://severalnines.com/wp-content/uploads/2023/12/BLOG-Whats-new-in-SQL-Server-2022.png) | 
| **SignalR** | Real-time communication for instant booking notifications and live updates. | ![SignalR Logo](https://www.tatvasoft.com/outsourcing/wp-content/uploads/2023/10/SignalR-in-.NET-Core-768x389.jpg) |
| **Azure Cloud** | Hosting the application for global scalability, reliability, and integrated DevOps support. | ![Azure Logo](https://upload.wikimedia.org/wikipedia/commons/f/fa/Microsoft_Azure.svg) |
| **SSLCommerz** | Secure, trusted online payments for bus, hotel, and car bookings. | ![SSLCommerz Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-bHSZzsY01bs7119i52uG2X-UbDe-sebdvA&s) |
| **DataTables.js** | Rich, dynamic tables with search, filter, pagination, and export features in admin panels. | ![DataTables Logo](https://wpdatatables.com/wp-content/uploads/2021/08/sortable.jpg) |
| **AdminLTE** | Elegant and responsive admin dashboard template for backend management. | ![AdminLTE Logo](https://github-production-user-asset-6210df.s3.amazonaws.com/51070104/271203234-3a7c2332-063f-4240-9d42-5cbc3169d6e1.jpg) |
| **Serilog** | Structured logging for better monitoring, debugging, and issue tracking. | ![Serilog Logo](https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2Fp1ofc8hkeyhmh23uplhp.png) |
| **Autofac** | Dependency Injection (DI) management, improving code flexibility and testability. | ![Autofac Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTj_VpyLo6ii9zBl2S6qLirEBFbMwtUptDeQw&s) |
| **Identity Framework** | Handles user authentication, authorization, and secure password storage. | ![Identity Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdkpc1TDCHOZ4cxJjNwTAIo4W7t9tS0YLcXg&s) |
| **AutoMapper** | Simplifies object-to-object mapping (DTOs ↔ Entities) to keep code clean and organized. | ![AutoMapper Logo](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSW3l2U8riN6-ry7-sQf6QpBskdiSEXwkn6eg&s) |
